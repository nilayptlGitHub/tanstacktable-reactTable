...
const getCommonPinningStyles = (column) => {
  ...
  return {
    ...
    zIndex: isPinned ? 2 :1,
    background: isPinned ? 'white' : undefined, // Ensure pinned columns have a solid background
  };
};
...
export default function App() {
  ...
  const table = useReactTable({
    ...
    initialState: {
      ...
      columnPinning: {
        left: ['id', 'category'], // Pin the first two columns to the left
      },
    },
    ...
    <div className="flex flex-col min-h-screen max-w-screen mx-16 py-12 px-4 sm:px-6 lg:px-8">
      <div className='mb-4 relative flex item-center w-2/3'>
        <input
          ...
          placeholder='Search...'
          className='w-1/2 pl-10 pr-4 h-10 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500'
        />
        <Search
